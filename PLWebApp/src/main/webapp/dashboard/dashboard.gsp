<div>
	...
	<p style="margin: 0 auto;width:400px;background-color:#ffffaa;padding:15px;line-height:1.6em;font-size:15px;">＊＊＊瞭解如何取得 TQC+ Java 6 與 PLWeb 平台及其他教學資源授權，請使用此<a href="contact/tqcplus_java.groovy" class="embedded-link"><b>線上聯繫表單</b></a>。（本功能僅提供教師使用）</p>
