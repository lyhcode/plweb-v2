...
if (!has_contact) {
	...
	phone2 = ''
	message = '我想瞭解如何取得 TQC+ Java 6 與 PLWeb 授權，請與我連絡！'
}
else {
...
html.html {
	...
	body {
		...
		p ('說明')
		ol (style: 'font-size:1.25em;line-height:1.4em;') {
			li ('本授權聯繫功能僅限教師申請。')
			li ('因 TQC+ Java 認證題庫版權為 CSF 電腦技能基金會所有，需要先取得基金會授權同意。')
			li {
				a (href: 'http://www.tlrcct.yuntech.edu.tw/project/school.aspx', target: '_blank', '中區夥伴學校')
				span ('已由教育部補助 PLWeb 計劃向 CSF 取得 TQC+ Java 授權，夥伴學校教師可直接開課使用，無需申請授權。')
			}
			li {
				span ('PLWeb 計劃亦提供各級學校免費試用辦法，歡迎留下聯繫方式，我們將協助您於近期開課。')
			}
		}
