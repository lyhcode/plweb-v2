...
""", [class_id, course_id, lesson_id]) {
		...
		COURSEDATA.put(qid, [TYPE: it.TYPE, TIME_PASSED: it.TIME_PASSED, IS_PASSED: it.IS_PASSED, TIME_UPDATED: it.TIME_UPDATED, TIME_USED: it.TIME_USED, IS_REVIEWED: it.IS_REVIEWED])
